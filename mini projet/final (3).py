...
# # <b>L'objectif de ce mini projet:</b>
# 
# Ce mini projet Consiste à réaliser une interface graphique qui contient des méthodes numériques pour évaluer la valeur de l’intégrale d'une fonction donnée.

# Les méthodes  utilisées sont:
# - <b> Méthode des rectangle gauche<b>
# * Méthode des points Milieu
# * Méthode de Trapeze
# * Méthode de Simpson
# 

# Si f est une fonction continue sur un intervalle <b>[a,b]</b>, bien souvent on ne sait pas calculer une primitive de f. Ainsi, si l'on désire obtenir la valeur de <img src="fonction.PNG"/>il faut parfois se contenter d'obtenir une valeur approchée à l'aide d'une méthode d'intégration numérique.
...
# on essaie d'approcher<img src="f2.PNG"/>
...
# <b>Pour bien utiliser l'application, il faut choisir les paramétres suivantes:</b>
# 
# - La fonction qu'on va utiliser
# * Le nombre des points
# * La valeur de "a" et "b"
# * Pour afficher les figures selon les methodes proposées, il suffit de cliquer  sur le bouton <b>Afficher<b>.

# <img src="exemple1.gif" width="750" align="center">
# 
